...
class StudentActions extends \Magento\Ui\Component\Listing\Columns\Column
{
    /**
     * Url path
     */
                ...
                if (isset($item['student_id'])) {
                    ...
                    $item[$this->getData('name')] = [
                        ...
                        'delete' => [
                            ...
                            'label' => __('Delete'),
                            'confirm' => [
                                'title' => __('Delete student %1', $studentName),
                                'message' => __('Are you sure you want to delete student %1 ?', $studentName),
                            ],
                            'post' => true,
                        ],
                        'widget' => [
